...
{
    internal class ComparaMitjansPerQuantitatDEtiquetes : IComparer<Cataleg_multimedia.superclasse.Mitja>
    {
        public int Compare(Mitja obj1, Mitja obj2)
        {
            ...
            else return obj1.Etiquetes.Count.CompareTo(obj2.Etiquetes.Count);
        }
    }
}
